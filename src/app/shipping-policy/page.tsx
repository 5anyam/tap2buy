      ...
      <section className="bg-[#1A1410] py-14 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-1.5 mb-5">
            <Truck className="w-3.5 h-3.5 text-[#8A4B24]" />
            <span className="text-xs font-semibold text-[#E0D5C4] uppercase tracking-wider">Fast & Secure Delivery</span>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-6">
        ...
        <div className="bg-white rounded-sm border border-gray-100 shadow-sm p-6">
          <p className="text-sm text-gray-600 leading-relaxed mb-3">
            At <span className="font-semibold text-[#8A4B24]">Tap2Buy</span>, we understand that a seamless shopping experience extends beyond your purchase — it is about timely, secure, and transparent delivery every step of the way.
          </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between gap-2 mb-1.5">
                    ...
                    <span className="text-[10px] font-bold text-[#8A4B24] bg-[#F3EBE0] px-2.5 py-1 rounded-full flex-shrink-0 border border-[#8A4B24]/20">
                      {item.highlight}
                    </span>
                  </div>
        ...
        <div className="bg-white rounded-sm border border-gray-100 shadow-sm p-6">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={index}
                className="text-center p-5 bg-gray-50 rounded-sm border border-gray-100 hover:border-[#8A4B24]/20 hover:shadow-sm transition-all"
              >
                <div className="text-3xl mb-2">{area.icon}</div>
                <h4 className="text-sm font-bold text-gray-900 mb-1">{area.region}</h4>
                <p className="text-xs text-[#8A4B24] font-semibold mb-2">{area.time}</p>
                <p className="text-[11px] text-gray-400">{area.examples}</p>
              </div>
            ))}
          </div>
          {/* Free shipping note */}
          <div className="mt-4 flex items-center gap-2 bg-green-50 border border-green-100 rounded-sm p-3">
        ...
        <div className="bg-[#1A1410] rounded-sm p-6 relative overflow-hidden">
          ...
          <p className="relative z-10 text-sm text-[#CBBBA8] leading-relaxed italic text-center max-w-2xl mx-auto">
            At <span className="text-[#8A4B24] font-semibold not-italic">Tap2Buy</span>, every shipment is more than a parcel — it is a promise delivered with care, speed, and reliability.
          </p>
        </div>
        ...
        <div className="bg-white rounded-sm border border-gray-100 shadow-sm p-6 md:p-8">
          <div className="flex items-center gap-2 mb-6">
            <div className="w-8 h-8 bg-[#F3EBE0] rounded-sm flex items-center justify-center">
              <Truck className="w-4 h-4 text-[#8A4B24]" />
            </div>
          ...
          <div className="flex flex-wrap justify-center items-center gap-6">
            {badges.map((badge, i) => (
              <div key={i} className="flex items-center gap-2">
                <div className="w-7 h-7 bg-[#F3EBE0] rounded-sm flex items-center justify-center">
                  <badge.icon className="w-4 h-4 text-[#8A4B24]" />
                </div>
        ...
        <p className="text-xs text-gray-400 text-center pb-4">
          ...
          <Link href="/returns-and-refunds-policy" className="text-[#8A4B24] hover:underline">Return Policy</Link>
          {' '}&nbsp;·&nbsp;{' '}
