    ...
    content: (
      <div className="space-y-3">
        <p className="text-sm text-gray-600 leading-relaxed">
          ...
          <span className="font-semibold text-[#8A4B24]">7 days of delivery</span> with valid proof or documented evidence.
        </p>
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="bg-[#1A1410] py-14 px-4 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-1.5 mb-5">
            <Scale className="w-3.5 h-3.5 text-[#8A4B24]" />
            <span className="text-xs font-semibold text-[#E0D5C4] uppercase tracking-wider">Legal Agreement</span>
          </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 space-y-6">
        ...
        {/* Closing Statement */}
        <div className="bg-[#1A1410] rounded-sm p-7 text-white text-center relative overflow-hidden">
          <div className="absolute top-0 right-0 w-48 h-48 bg-[#8A4B24]/10 rounded-full blur-3xl pointer-events-none" />
          <p className="relative z-10 text-sm text-[#CBBBA8] leading-relaxed max-w-2xl mx-auto">
        ...
        {/* CTA */}
        <div className="bg-white rounded-sm border border-gray-100 shadow-sm p-6 text-center">
